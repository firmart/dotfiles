" vim: et sw=2 sts=2
" NOTE: modified colorscheme, see below for the original
...
highlight CursorLineNr guifg=#878787 ctermfg=226 guibg=#3a3a3a ctermbg=237 gui=NONE cterm=NONE
...
highlight Folded ctermfg=119 ctermbg=237 cterm=NONE guifg=#878787 guibg=#3a3a3a gui=NONE
